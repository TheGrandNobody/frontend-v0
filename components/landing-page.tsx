            ...
            <div className="hidden lg:flex lg:gap-x-12">
              {navigation.map((item) => (
                  <a key={item.name} href={item.href}
                     className="text-sm font-semibold leading-6 text-white hover:text-highlight">
                    {item.name}
                  </a>
              ))}
            </div>
          ...
          <section id="mission" className="bg-[#55286f] py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl lg:text-center">
                ...
                <p className="mt-6 text-lg leading-8 text-[#d8b4e2]">
                  We're here to ease the burden on teachers' shoulders, put their time back in their hands, and help
                  them enjoy the work they love.
                </p>
              </div>
            </div>
          </section>
          ...
          <section id="what-we-do" className="py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl lg:text-center">
                ...
                <p className="mt-6 text-lg leading-8 text-[#d8b4e2]">
                  We designed an essential suite of tools ready to accompany teachers every step of the way, any time of
                  the day.
                </p>
              </div>
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              ...
              <div className="mt-16 flex flex-col lg:flex-row items-center justify-center gap-8">
                <div className="w-full lg:w-1/2">
                  <Image src="/demo.gif" alt="Product Demo" className="rounded-lg shadow-xl" width={2000}
                         height={2000}/>
                </div>
                <div className="w-full lg:w-1/2 space-y-4">
                  <h3 className="text-2xl font-bold text-white">Slate: The Educator's Workbench</h3>
                  <p className="text-[#d8b4e2]">Slate streamlines administrative tasks, freeing up valuable time for
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-4">
                <a href="http://www.softwarefreedom.org/">
                  <Image src="http://www.softwarefreedom.org/img/support-sflc.png" alt="Support SFLC" height={31}
                         width={88}/>
                </a>
                <a rel="license" href="http://creativecommons.org/licenses/by/4.0/">
                  <Image alt="Creative Commons License" src="https://i.creativecommons.org/l/by/4.0/88x31.png"
                         width={88} height={31}/>
                </a>
              </div>
